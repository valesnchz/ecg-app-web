...
const ManualView: React.FC = () => {
    ...
    const sections = [
        ...
        },
        {
            ...
            content: 'Use our AI engine for diagnostic guidance. Enter at least 5 clinical parameters (such as heart rate, heart rhythm, blood pressure, etc.) and the application will generate an educational risk assessment based on clinical patterns.'
        },
        {
